...
type AuthContextType = {
  ...
  register: (data: { nombre: string; apellido: string; email: string; identificacion: string; password: string }) => Promise<void>;
  updateProfile: (data: Partial<Pick<User, 'nombre'|'apellido'|'email'|'identificacion'>>) => Promise<void>;
